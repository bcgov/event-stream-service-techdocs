...
Use the following pages to help you when doing DevOps for the application.

Communicating with the users:

* [Outage Communications](Outage-Communications): how to communicate with the users when there is a planned or unplanned outage
